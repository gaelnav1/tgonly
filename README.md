...
Copia `.env.example` a `.env.local` para desarrollo. Configura `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `ADMIN_PASSWORD` y `TELEGRAM_BOT_TOKEN`. No publiques sus valores en Git.
